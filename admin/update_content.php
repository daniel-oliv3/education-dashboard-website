...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Atualizar o status <span>*</span></p>
      ...
      <textarea name="description" class="box" required placeholder="Escrever descrição" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Atualizar lista de reprodução</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--selecionar lista de reprodução</option>
         <?php
      ...
      <div class="flex-btn">
         ...
         <input type="submit" value="Excluir conteúdo" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
